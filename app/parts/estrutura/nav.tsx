...
export default function MobileNav({
    ...
    return (
        <>
            ...
            <nav
                onClick={() => setIsOpen(false)}
                className={`fixed top-0 h-screen w-96 bg-blue-500 pt-2 px-4 z-50 text-center text-base transition-all duration-300 ease-in-out font-open ${isOpen ? "right-0" : "-right-full"
                    }`}
            >
                {/* Botão fechar */}
                <div
