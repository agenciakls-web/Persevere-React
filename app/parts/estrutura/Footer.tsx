            ...
            <footer className="bg-blue-500 py-6 md:py-12 text-white font-brandon">
                <div className="container mx-auto px-4">
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-y-10 gap-x-6 md:gap-x-16">
                        ...
                        {/* Menu Column */}
                        <div>
                            <h3 className="py-3 text-base 2xl:text-2xl font-semibold">MENU</h3>
                        ...
                        {/* Contact Column */}
                        <div>
                            <h3 className="py-3 text-base 2xl:text-2xl font-semibold">CONTATO</h3>
                            <hr className="w-6 mb-4 border-2 border-solid border-orange-500" />
                        ...
                        {/* Social Media Column */}
                        <div>
                            <h3 className="py-3 text-base 2xl:text-2xl font-semibold">REDES SOCIAIS</h3>
                            <hr className="w-6 mb-4 border-2 border-solid border-orange-500" />
