...
export default function ListImoveisCard({ imovel }: { imovel: Imovel }) {
  ...
  const fotoCapa =
    ...
    "/img/sem-foto.png"; // fallback cinza em /public/img/sem-foto.png
    ...
    >
      ...
      <div className="p-4">
        ...
        <p className="mt-2 text-gray-500">
          {imovel.QtdDormitorios} quartos • {imovel.QtdBanheiros} banheiros
        </p>
        <p className="text-gray-500">{imovel.QtdVagas} vagas</p>
        {imovel.AreaTotal && (
          <p className="text-gray-500">{imovel.AreaTotal}m²</p>
        )}
        {imovel.PrecoVenda && (
