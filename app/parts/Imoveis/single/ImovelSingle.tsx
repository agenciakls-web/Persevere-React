                                ...
                                <div className="rounded-xl h-full overflow-hidden shadow-lg shadow-gray-300 bg-white">
                                    <div className="px-6 py-4">
                                        ...
                                        <div className="space-y-2 text-gray-600 text-base">
                                            ...
                                            {/* Dados Cronológicos adicionados do XML */}
                                            {imovel.AnoConstrucao && imovel.AnoConstrucao > 0 && (
                                                <div>📅 Ano de Construção: <span className="font-semibold">{imovel.AnoConstrucao}</span></div>
                                            )}
