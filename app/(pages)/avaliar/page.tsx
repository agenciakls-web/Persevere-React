                ...
                <div className="w-1/2">
                    ...
                    <form action="" method="post" id="form-evaluates">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <input type="radio" name="status" value="Regular" className="mx-2" id="status-regular"><label for="status-regular">Regular</label>
                                <input type="radio" name="status" value="Bom" className="mx-2" id="status-bom"><label for="status-bom">Bom</label>
                                <input type="radio" name="status" value="Excelente" className="mx-2" id="status-excelente"><label for="status-excelente">Excelente</label>
                            </div>
