            ...
            {STEPS.map((step) => (
              <div key={step.id} className="flex flex-col items-center">
                <div className="relative w-full flex justify-center">
                  {/* Linha Conectora (Progress Bar) */}
                  {step.id !== 1 && (
                    <div className="absolute right-1/2 -translate-x-5 top-1/2 w-full h-0.5 bg-gray-100 z-0">
                      <div 
                  ...
                  <div className={`relative z-10 w-10 h-10 rounded-full flex items-center justify-center transition-colors duration-300 ${
