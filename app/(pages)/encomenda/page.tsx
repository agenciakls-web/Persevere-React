                ...
                <div className="w-1/2">
                    ...
                    <form action="" method="post" id="form-orders">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <textarea name="description" id="description" className="w-full py-3 px-4 rounded-lg text-lg font-medium border text-gray-500 md:col-span-2" cols="30" rows="5" placeholder="Descreva as características aqui"></textarea>
