                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-x-4">
                        <div>
                            <form id="form-contact" onSubmit={handleSubmit(onSubmit)}>
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <input type="hidden" {...register("action")} value="contact" />
                        ...
                        <div className="text-xl text-black rounded-xl font-brandon">
                            <div className="border-orange-500 border-blue-500 border-2 rounded-xl text-lg p-6 my-3 md:mt-0">
                                ...
                                {/* Email */}
                                <a href="mailto:contato@persevere.com.br" target="_blank" rel="noreferrer">
                                    <div className="flex justify-start items-center pt-4 pb-6 rounded-lg hover:bg-gray-100">
                                        <div className="px-6 text-4xl text-blue-500">
                                ...
                                >
                                    <div className="flex justify-start items-center pt-4 pb-6 rounded-lg hover:bg-gray-100">
                                        ...
                                        <div>
                                            ...
                                            <div>
                                                Rua Prof. Cardoso de Menezes, QD 115 - LT 6 - Loja 1, Bairro:
                                                Jardim Atlântico - Itaipuaçu - Maricá/RJ - CEP: 24935-425
                                            </div>
                                        </div>
                                    </div>
                                </a>
